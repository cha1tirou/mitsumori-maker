...
export const metadata: Metadata = {
  ...
  keywords:
    "フリーランス新法, 特定受託事業者法, 一人親方, 建設業, 下請法, 書面交付義務",
  openGraph: {
    title: "フリーランス新法と建設業一人親方への影響【2026年版】",
    description:
      "フリーランス新法が建設業一人親方に与える影響を解説。発注者の義務・書面交付・報酬支払・禁止行為・見積書での対応まで。",
    url: "https://mitsumori-maker.com/construction/guide/freelance-law-construction",
    siteName: "ケンミツ",
    locale: "ja_JP",
    type: "article",
  },
    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <main className="max-w-3xl mx-auto px-4 py-10">
        <article>
          ...
          <h3 className="text-base font-bold text-gray-900 mt-6 mb-2">
            1. 取引条件の書面交付義務
          </h3>
          <p className="text-gray-700 leading-relaxed mb-4">
          ...
          <p className="text-gray-700 leading-relaxed mb-4">
            ...
            は、改正建設業法 2025 とフリーランス新法の両方を意識したフォーマットを標準で採用しています。見積条件書・労務費内訳・支払条件・瑕疵担保のすべてを漏れなく記載できるため、中小建設業者でも法令準拠の見積書を簡単に作成できます。
          </p>
          ...
          <div className="mt-12 bg-kenmitsu-navy900 rounded-xl p-8 text-center text-white">
            ...
            <p className="text-white/70 mb-4 text-sm">
              メアド登録だけで利用開始 / 有料プラン月¥1,980〜・中小建設業者のための、法令対応の見積書メーカー
            </p>
            <Link
