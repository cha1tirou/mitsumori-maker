...
export const metadata: Metadata = {
  ...
  description:
    "2025年12月全面施行の改正建設業法に自社が対応できているか、30項目で無料セルフチェック。労務費の内訳明示・法定福利費・見積条件書・瑕疵担保など実務項目を8セクションに整理。PDFを無料配布。中小建設業者向け。",
  keywords:
    "改正建設業法 チェックリスト, 建設業法 2025, 見積書, 対応, 無料, ダウンロード, 中小建設業者, 労務費, 法定福利費",
  openGraph: {
    title:
...
const faqs = [
  ...
  {
    q: "このチェックリストは個人事業主でも使えますか？",
    a: "はい、むしろ中小建設業者の現場感覚に合わせて作っています。30項目のうち「法人のみ対象」の項目が1〜2ありますが、それ以外は個人事業主でも該当します。労務費内訳明示や法定福利費計上は、規模に関係なく改正法の適用対象です。",
  },
  {
  ...
  },
  {
    ...
    a: "このチェックリストは自己診断用の資料です。一方『ケンミツ』はチェックリストの各項目を実務フローに組み込んだ、建設業特化の見積書作成Webアプリで、労務費内訳・法定福利費・見積条件書の必須項目を入力画面で自動チェックしながら作成できます。メールアドレス登録だけで無料お試しできるので、チェックリストで課題を把握した後にそのままツールでも確認いただけます。",
  },
];
