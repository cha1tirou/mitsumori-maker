...
const faqsForLd = [
  ...
  {
    q: "支払い方法は何が使えますか？",
    a: "クレジットカード決済のみ対応しています（決済代行は Stripe）。対応カードブランドは Visa / Mastercard / JCB / American Express / Diners Club。銀行振込・コンビニ決済・法人向け請求書払い（後払い）には対応していません。",
  },
  {
    q: "領収書は発行されますか？",
    a: "はい。決済完了時に Stripe（決済代行）から自動で領収書 PDF がメール送付されます。マイページの「領収書の発行方法」からも過去分をいつでも再取得できます。発行者「ケンミツ」・住所・支払日・領収書番号が記載されます。",
  },
];
