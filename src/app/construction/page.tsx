...
export const metadata: Metadata = {
  ...
  description:
    "中小建設業者向けの見積書作成ツール。改正建設業法 2025 対応 PDF が月¥980 で出せるサービスはケンミツだけ。無料登録で見積書は何枚でも作成・PDF ダウンロード可。",
  keywords:
...
const faqsForLd = [
  ...
  {
    q: "違反するとどうなりますか？",
    a: "監督官庁から段階的に処分が下されます。指導 → 勧告 → 企業名公表（インターネット上に掲載）→ 業務改善命令 → 営業停止 → 建設業許可の取消、という順です。経営事項審査評点も下がり、公共工事入札で不利になります。さらに元請けからの見積書差し戻し・取引縮小・取引停止といった実害のリスクもあります。",
  },
  {
    q: "なぜケンミツは月¥980 で改正法対応にできるのですか？",
    a: "建設業向けの業務管理 SaaS は、顧客・案件・工程・原価・帳票をフル装備した月¥9,800〜¥30,000 のプロダクトが中心です。ケンミツは「中小建設業者の見積書作成」に機能を絞り込むことで、改正法対応 PDF を月¥980 で提供できます。",
  },
  {
    q: "Free プランと Solo プランの違いは？",
    a: "見積書の作成・編集・保存・通常 PDF 出力は Free プランで全て無制限に使えます。Solo プラン（月¥980）にすると、改正建設業法 2025 対応版の PDF（労務費・法定福利費・経費の内訳明示）が出力でき、リアルタイム法令チェッカー・取引先マスタ・単価マスタ・原価粗利分析・工事写真添付などの機能も解放されます。",
  },
  {
    q: "解約はいつでもできますか？",
...
export default async function ConstructionLandingPage() {
  ...
  const softwareLd = {
    ...
    operatingSystem: "Web",
    description:
      "中小建設業者向けの建設業特化・見積書作成クラウドツール。改正建設業法2025対応の PDF を月¥980 で出力可能。",
    offers: [
      {
        "@type": "Offer",
        name: "Free プラン",
