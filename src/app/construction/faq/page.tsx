  ...
  },
  {
    ...
    items: [
      ...
      },
      {
        ...
        a: "解約後もデータは180日間保管されます。この期間中はFreeプラン（月3通・透かし付きPDF）として引き続き閲覧・PDF出力が可能です。編集・複製・メール送信はSoloプラン限定機能のため利用できなくなります。180日を過ぎるとデータは完全に削除されます。再度Soloプランに契約すれば、保管期間中のデータにフルアクセスが復活します。",
      },
      {
        q: "7日間の無料トライアル後はどうなりますか？",
        a: "トライアル期間が終了すると自動でFreeプランに移行します。課金は一切発生しません。トライアル中に作成した見積書はそのまま残り、Freeプランの範囲（月3通・透かし付きPDF）でご利用いただけます。",
      },
    ],
  },
  {
