...
const faqCategories: FaqCategory[] = [
  {
    ...
    items: [
      {
        q: "無料で使えますか？",
        a: "はい。メールアドレスとパスワードだけで無料登録でき、見積書は何枚でも作成・PDF ダウンロード・クラウド保存できます。クレジットカード登録は不要です。改正建設業法のルールに沿った見積書を作成したい場合のみ、有料プラン（月¥980）にアップグレードしてください。",
      },
      {
      ...
      {
        q: "法人契約・請求書払いはできますか？",
        a: "申し訳ございませんが、現時点では対応しておりません。有料プランは中小建設業者向けの小規模プラン（月¥980）として、クレジットカード決済のみでの提供となります。複数アカウントが必要な工務店向けの Team プランは検討段階です。",
      },
    ],
  },
  {
