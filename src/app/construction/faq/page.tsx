...
const faqCategories: FaqCategory[] = [
  {
    ...
    items: [
      {
        q: "無料で使えますか？",
        a: "はい。メールアドレスとパスワードだけで無料登録でき、見積書は何枚でも作成・PDF ダウンロード・クラウド保存できます。クレジットカード登録は不要です。改正建設業法 2025 対応版 PDF を出力したい場合のみ、Solo プラン（月¥980）にアップグレードしてください。",
      },
      {
        q: "Soloプランでできるようになることは何ですか？",
        a: "改正建設業法 2025 対応版 PDF（労務費・法定福利費・経費の内訳明示）の出力、取引先マスタ・単価マスタのサーバー同期、原価・粗利分析、工事写真の埋込など。Free プランでも見積書の作成・編集・保存・通常 PDF 出力は無制限に利用できます。",
      },
      {
        q: "年払いは割引がありますか？",
      ...
      {
        q: "法人契約・請求書払いはできますか？",
        a: "申し訳ございませんが、現時点では対応しておりません。Soloプランは中小建設業者向けの小規模プラン（月¥980）として、クレジットカード決済のみでの提供となります。複数アカウントが必要な工務店向けの Team プランは検討段階です。",
      },
    ],
  },
  {
  ...
  },
  {
    ...
    items: [
      ...
      },
      {
        ...
        a: "解約後もデータは180日間保管されます。この期間中は Free プランとして引き続き閲覧・通常版 PDF 出力が可能です。改正建設業法対応版 PDF・編集・複製・マスタ機能はSoloプラン限定機能のため利用できなくなります。180日を過ぎるとデータは完全に削除されます。再度Soloプランに契約すれば、保管期間中のデータにフルアクセスが復活します。",
      },
    ],
  },
  {
