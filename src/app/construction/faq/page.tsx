...
const faqCategories: FaqCategory[] = [
  {
    ...
    items: [
      ...
      },
      {
        ...
        a: "改正建設業法のルールに沿った見積書（労務費・法定福利費・経費の内訳明示）の作成、取引先マスタ・単価マスタのサーバー同期、原価・粗利分析、工事写真の埋込など。Free プランでも見積書の作成・編集・保存・通常 PDF 出力は無制限に利用できます。",
      },
      {
        q: "年払いは割引がありますか？",
        a: "はい。Solo 年額 ¥19,800（月額換算 ¥1,650、約2ヶ月分お得）、Team 年額 ¥29,800 となっています。Stripe Checkout の画面で月額/年額を選択できます。",
      },
      {
        q: "Teamプランは使えますか？",
