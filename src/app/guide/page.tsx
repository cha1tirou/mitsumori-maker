...
export const metadata: Metadata = {
  ...
  description:
    "見積書の書き方・必須項目・消費税・有効期限・宛名・振込先など、実務ですぐ使えるガイド記事を66本掲載。フリーランス・個人事業主・業種別の記載例も網羅。",
  openGraph: {
    title: "見積書ガイド一覧｜書き方・テンプレート・業種別まとめ",
    description: "見積書の書き方・必須項目・消費税・有効期限・宛名・振込先など実務ですぐ使えるガイド記事を66本掲載。",
    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <main className="max-w-4xl mx-auto px-4 py-10">
        ...
        <p className="text-gray-600 mb-10 leading-relaxed">
          見積書の書き方・必須項目・消費税・有効期限・宛名など、実務で即使えるガイドを66本掲載しています。
