...
export const metadata: Metadata = {
  ...
  description:
    "見積書の前提条件の書き方を具体例付きで解説。作業範囲・納期・価格条件など、そのままコピペで使えるテンプレートを業種別に紹介。前提条件を正しく書いてトラブルを未然に防ぎましょう。",
  openGraph: {
    title: "見積書の前提条件の書き方【記載例・テンプレ付き】 | 見積書メーカー",
    description:
      "見積書の前提条件の書き方を具体例付きで解説。そのままコピペで使える業種別テンプレートを紹介。",
