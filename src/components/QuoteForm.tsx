...
const inputClass =
  "w-full rounded-lg border border-gray-200 px-3 py-2 text-sm transition-colors hover:border-gray-300 focus:border-accent";

export default function QuoteForm({ data, onChange }: Props) {
    ...
    <div className="space-y-6">
      ...
      <section className="bg-white rounded-2xl p-5 shadow-sm border border-gray-100">
        ...
        <div className="space-y-3">
          ...
          <button
            onClick={addItem}
            className="w-full rounded-xl border-2 border-dashed border-gray-200 py-3 text-sm text-gray-400 hover:border-accent hover:text-accent transition-colors"
          >
            ＋ 明細を追加
          </button>
        </div>
