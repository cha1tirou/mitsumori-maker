    ...
    <div className="space-y-6">
      ...
      <section className="bg-white rounded-2xl p-5 shadow-sm border border-gray-100">
        ...
        <div className="space-y-3">
          ...
          <button
            onClick={addItem}
            className="w-full rounded-xl border-2 border-dashed border-gray-200 py-3 text-sm text-gray-400 hover:border-blue-500 hover:text-blue-500 transition-colors"
          >
            + 明細を追加
          </button>
        </div>
          ...
          <div className="grid grid-cols-3 gap-3">
            <Field label="口座種別">
              <select
                ...
                onChange={(e) => update("accountType", e.target.value as "普通" | "当座")}
              >
      ...
      <section className="bg-white rounded-2xl p-5 shadow-sm border border-gray-100">
        ...
        <textarea
          ...
          placeholder="振込手数料はお客様のご負担でお願いいたします。"
          value={data.notes}
