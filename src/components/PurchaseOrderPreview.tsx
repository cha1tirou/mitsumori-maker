...
export default function PurchaseOrderPreview({ data }: Props) {
      ...
      >
        <div className="bg-white w-[210mm] min-h-[297mm] p-[15mm] text-[11px] leading-relaxed text-gray-800 font-sans">
          ...
          <div className="text-center mb-8">
            <h1 className="text-2xl font-bold text-purple-900 tracking-widest">
              発 注 書
            </h1>
            <div className="w-16 h-0.5 bg-purple-500 mx-auto mt-2" />
          </div>
          ...
          <div className="flex justify-between mb-8">
            {/* 発注先 */}
            <div className="w-[48%]">
              <div className="border-b-2 border-purple-900 pb-1 mb-3">
              ...
              <div className="mt-4 bg-purple-50 border border-purple-200 rounded-lg px-4 py-3">
                <div className="text-xs text-gray-500 mb-1">発注金額（税込）</div>
            ...
            <div className="w-[40%] text-right text-xs text-gray-600 space-y-0.5">
              ...
              <div className="mt-2 space-y-0.5">
                {data.orderNumber && <p>発注書番号: {data.orderNumber}</p>}
                <p>発注日: {formatDate(data.orderDate)}</p>
                {data.deliveryDate && (
          ...
          <div className="flex justify-end mb-8">
            <div className="w-64">
              ...
              <div className="flex justify-between py-2 border-t-2 border-purple-900 mt-1 text-sm font-bold text-purple-900">
                <span>合計（税込）</span>
