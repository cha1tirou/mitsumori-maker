...
const items: { kind: IluKind; tag: string; title: string; body: string }[] = [
  {
    ...
    body: "2025年12月施行の改正建設業法2025が求める労務費の内訳明示・「一式」表記の注意喚起・見積条件書の必須記載項目を自動チェック。法令遵守のための判断をツールが支援します。",
  },
  {
    kind: "presets",
    tag: "プリセット",
  ...
  },
  {
    kind: "phone",
    tag: "マルチデバイス",
    title: "PC でもスマホでも、同じ画面で完結",
    body: "事務所の PC でじっくり、現場のスマホで即対応。同じアカウントで端末を行き来でき、入力途中の見積も自動保存で続きから編集できます。",
  },
  {
    kind: "rocket",
    tag: "即時",
    title: "メアド登録だけで、すぐ使える",
    body: "他社ツールのように「お問い合わせ→デモ」の重い入口はありません。メールアドレスとパスワードだけで 30 秒で登録、すぐに見積書を作り始められます。",
  },
  {
    kind: "cloud",
    tag: "クラウド",
